...
class PintFieldTypography(
    ...
    companion object {
        ...
        // Conservative upper bounds for Roboto Condensed Bold after the XML's textScaleX=0.68.
        // They are deliberately rounded above the font's measured advances so Android rounding and
        // system-font revisions cannot make a boundary-fit calculation optimistic.
        ...
        fun forLayout(
            ...
            val (maxCountTextSizeSp, fixedWidthDp) = when (layout) {
                PintFieldLayout.REGULAR -> REGULAR_MAX_COUNT_TEXT_SIZE_SP to REGULAR_MUG_AND_MARGIN_WIDTH_DP
            ...
            return PintFieldTypography(
                countTextSizeSp = countTextSizeSp,
